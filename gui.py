...
#     history_listbox.insert(END, action)
...
#     # Оновити історію атак
#     update_history(f"Знищена позиція: {request3}, {request4} з {selected_position} за допомогою {selected_artillery}")
...
# # Додати список для історії атак
# history_listbox = Listbox(win, font=("Arial", 10), width=80, height=10)
# history_listbox.place(x=805, y=150)
